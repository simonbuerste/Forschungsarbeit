...
from D_FSAE1 import fsae_model_fn
...
# restore_from = 'C:/Users/simon/Documents/Uni_Stuttgart/Forschungsarbeit/Code/Models/VAE/best_weights/'
restore_from = os.path.join(os.path.expanduser('~'), 'no_backup', 's1279', 'Models', 'AE_F-MNIST_kmeans_2019-04-17_07-42', 'best_weights')
...
parser.add_argument('--dataset', default='F-MNIST',
                    help="Choose dataset which should be used")
parser.add_argument('--Parameters', default='params_Cluster.json',
...
if __name__ == '__main__':
    ...
    model_dir = os.path.join(model_dir, ('Clustering_' + args.latent_model + '_' + args.dataset + '_' + args.cluster_model + '_'
                                         + timestring))
    ...
    if args.latent_model == 'AE':
        ...
        latent_model_spec = b_ae_model_fn('cluster', cluster_inputs, params, reuse=False)
    ...
    if args.cluster_model == 'kmeans':
        ...
        train_and_evaluate_idec(cluster_model_spec, model_dir, params, config, restore_from, vars_to_restore)
